				...
				<div class="col-md-12">
				 <div class="form-group">
					...
					<select class="form-control select2" name="type" required>
                		   <option value="assets" @if($chartofaccount->type=='assets') selected="" @endif>{{ _lang('Assets') }}</option>
                		   <option value="liabilities" @if($chartofaccount->type=='liabilities') selected="" @endif>{{ _lang('Liabilities') }}</option>
                		   ...
                		   <option value="student fee" @php $chartofaccount->type=="student fee" ? "selected" : "" @endphp>{{ _lang('Student Fee') }}</option>
					</select>
				 </div>
				</div>
