...
<div class="row">
    <form action="{{ url('whatsapp/send-whatsapp') }}" class="validate" autocomplete="off" method="post" accept-charset="utf-8">
		<div class="col-md-8">				
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="panel-title" >
						{{ _lang('Compose WhatsApp Message') }}
					</div>
				</div>
				<div class="panel-body">
					...
					<div class="col-md-12">
					<div class="form-group">
    <label class="control-label">{{ _lang('Message') }} ( {{ _lang('MAX 4000') }} )</label>
    <textarea class="form-control" name="body" id="body_message" required>{{ old('body') }}</textarea>
</div>
