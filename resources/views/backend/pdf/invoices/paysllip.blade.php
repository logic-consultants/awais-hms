        ...
        <div class="col-md-12" style="padding: 0px;margin: 0px;">
            <div style="padding: 0px;">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        @foreach($receipt_no as $receipt)
                        <td class="pt-3 pb-3" ><b class="pm-0">{{_lang('Receipt No')}}:</b> 
                        <span>
                            {{ $receipt->receipt_no }}
                        </span>
                        </td>
                    ...
                    <tr>
                        <td class="pt-3 pb-3" class="text-left" width="50%"><b class="pm-0"> {{ _lang("Floor") }}:</b> <strong>{{$invoice->class_name}}</strong></td>
                        <td class="pt-3 pb-3" class="text-left" width="50%"><b class="pm-0"> {{ _lang("Room") }}:</b> <strong>{{$invoice->section_name}}</strong></td>
                    </tr>
                ...
                <div style="margin-top: 10px;"> 
                    <fieldset>
                        ...
                        <b>
                            {{_lang('Current Payslip Total')}}: {{ $currency." ".decimalPlace(@$invoiceItemsSum) }}
                        </b>

                       <p class="text-right" style="margin: 3px;"> 
                        <b>
                            {{_lang('Previous Balance')}}: {{ $currency." ".decimalPlace(@$total_previous_balance) }}
                        </b>
                        </p>

                        <p class="text-right" style="margin: 3px;"> 
                        <b>
                            {{_lang('Total Pending Dues')}}: {{ $currency." ".decimalPlace(@$total_previous_balance + @$invoiceItemsSum) }}
                        </b>
                        </p>
...
<script>
    ...
    window.location.href = "/invoices"; // replace with the correct route if needed
};
