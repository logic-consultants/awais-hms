				...
				<form action="{{route('class.store')}}" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
					...
					<div class="form-group">
					    <div class="col-md-12">
							...
							<input type="text" class="form-control" name="class_name" value="{{ old('class_name') }}" placeholder="Floor Name" required>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-12">
							<button type="submit" class="btn btn-primary">{{_lang('Add Floor')}}</button>
						</div>
					</div>
				</form>
			</div>
