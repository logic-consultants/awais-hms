...
<li>   
	<a href="#"><i class="fa fa-building-o"></i>{{ _lang('Rooms Setup') }}</a>
	<ul>
...
<!--
 ...
 <!--</li>-->
 <li>   
	<a href="#"><i class="fa fa-university"></i>{{ _lang('Accounts') }}</a>
	<ul>
	@if (has_permission('transactions.manage_income',Auth::User()->role_id))
	<li >
		<a href="{{route('master.account')}}">
			{{ _lang('Master Account') }}
		</a>
 </li>
	<li >
 ...
 <li>
	...
	<ul>
	   ...
	   @if (has_permission('transactions.manage_expense',Auth::User()->role_id))
	   <li @if(Request::is('transactions/accounting/cashbook')) class="active" @endif>
			<a href="{{ url('transactions/accounting/cashbook') }}">
				{{ _lang('Cash Book') }}
			</a>
	   </li>
	   @endif
	   ...
	   <li @if(Request::is('transactions/ledges')) class="active" @endif>
			<a href="{{ url('transactions/ledges') }}">
				{{ _lang('Ledgers') }}
			</a>
	   </li>
 ...
 <li>   
	...
	<ul>
	   ...
	   <!-- @if (has_permission('invoices.fee_receipt',Auth::User()->role_id))
	   <li @if(Request::is('invoices.fee_receipt')) class="active" @endif>
			<a href="{{route('invoices.fee_receipt',[0,0,0])}}">
				{{ _lang('Fee Receipt') }}
			</a>
	   </li>
	   @endif -->
	   @if (has_permission('student_ledger',Auth::User()->role_id))
	   <li @if(Request::is('student_ledger')) class="active" @endif>
			<a href="{{url('invoices/student/ledger/0/All')}}">
				{{ _lang('Student Ledger') }}
			</a>
	   </li>
	   @endif
 ...
 <li>   
  ...
  <li>   
	...
	<ul>
	   ...
	   @endif
	   @if (has_permission('sms.view_logs',Auth::User()->role_id))
	   <li @if(Request::is('Whatsapp/create-whatsapp')) class="active" @endif>
			<a href="{{ url('Whatsapp/create-whatsapp') }}">
				{{ _lang('Send WhatsApp') }}
			</a>
	   </li>
	   @endif
	   ...
	   @if (has_permission('sms.view_logs',Auth::User()->role_id))
	   <li @if(Request::is('whatsapp/logs')) class="active" @endif>
			<a href="{{ url('whatsapp/logs') }}">
				{{ _lang('WhatsApp Log') }}
			</a>
	   </li>
	   @endif
...
<li>   
 ...
 <li>   
	...
	<ul>
	   @if (has_permission('reports.report_area',Auth::User()->role_id))
	   <li @if(Request::is('reports/report_area')) class="active" @endif>
			<a href="{{ url('reports/report_area') }}">
				{{ _lang('Report Area') }}
			</a>
	   </li>
	   @endif
